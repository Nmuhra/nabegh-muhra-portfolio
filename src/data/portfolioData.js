...
const portfolioData = {
  ...
  projects: [{"title":"","description":"Developing a dynamic web application enabling users to upload CVs and generate personalized 3D portfolio websites. Utilizing OCR scanning for data extraction, an AI selection algorithm for content optimization, and Three.js for immersive 3D visualizations.","technologies":["OCR scanning","AI selection algorithm","Three.js"],"dateRange":"","url":""}],
  contact: {
    email: "",
    phone: "",
    linkedin: "",
